...
class DenseNet(nn.Module):
    def __init__(self, num_classes, init_channels=64, growth_rate=32, blocks=[6, 12, 24, 16]):
...
def DenseNet121(num_classes):
    return DenseNet(num_classes, init_channels=64, growth_rate=32, blocks=[6, 12, 24, 16])

def DenseNet169(num_classes):
    return DenseNet(num_classes, init_channels=64, growth_rate=32, blocks=[6, 12, 32, 32])

def DenseNet201(num_classes):
    return DenseNet(num_classes, init_channels=64, growth_rate=32, blocks=[6, 12, 48, 32])

def DenseNet264(num_classes):
    return DenseNet(num_classes, init_channels=64, growth_rate=32, blocks=[6, 12, 64, 48])
