...
# from net.transnext import transnext_base as create_model
...
# from net.model import swin_small_patch4_window7_224 as create_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--val_data', type=str, default="data_set2/archive_data/val")
    parser.add_argument('--weights', type=str, default='weights/MyDialog21-2.pth')
