...
# from net.shufflenet import shufflenet_g2 as create_model
...
def main(args):
    ...
    print(conf_matrix)
    plt.matshow(conf_matrix, cmap=plt.cm.Reds)  # 根据最下面的图按自己需求更改颜色
    # plt.colorbar()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--val_data', type=str, default="data_set/tumor_data/val")
